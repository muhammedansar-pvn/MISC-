        ...
        <header className="h-20 bg-white border-b border-[#E2E8E0] px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-2xs w-full min-w-0">
          ...
          <div className="flex items-center space-x-3 flex-1 max-w-md min-w-0">
            <button
              ...
              className="text-slate-500 hover:text-slate-800 p-2 rounded-xl hover:bg-slate-100 transition-all flex-shrink-0"
          ...
          <div className="flex items-center space-x-3 flex-shrink-0">
            ...
            <div className="hidden lg:flex items-center space-x-2 bg-[#F7F8F5] px-3.5 py-1.5 rounded-xl border border-[#E2E8E0] text-xs font-semibold text-slate-700">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2.5 p-1 rounded-xl hover:bg-slate-100 transition-all focus:outline-none"
              >
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl shadow-xl border border-[#E2E8E0] py-2 z-50">
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full flex items-center space-x-2 px-4 py-2 text-xs font-bold text-rose-600 hover:bg-rose-50 transition-all text-left mt-1"
                  >
                    <LogOut className="w-4 h-4" />
                    <span>Sign Out</span>
                  </button>
