      ...
      <div className="misc-container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            {/* Section Headline */}
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#172033] tracking-tight leading-tight">
              Fostering Spiritual Depth & Academic Rigor
            </h2>

            {/* Body Copy */}
            <div className="space-y-4 text-[#4B5563] text-base leading-relaxed font-normal">
              <p>
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {capabilities.map((item, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className="bg-white p-5 rounded-xl border border-[#E5EAF0] shadow-sm hover:border-[#3B82F6]/40 transition-all group"
                >
                  <div className="w-9 h-9 rounded-lg bg-[#EAF4FF] text-[#2563EB] flex items-center justify-center border border-[#DCEEFF] mb-3 group-hover:bg-[#2563EB] group-hover:text-white transition-colors">
                    <IconComp className="w-4 h-4" />
                  </div>
                  <h4 className="font-serif text-base font-bold text-[#172033] mb-1">
                    {item.title}
                  </h4>
