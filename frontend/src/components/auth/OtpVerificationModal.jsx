...
export const OtpVerificationModal = ({ verificationId: initialVerId, email: maskedEmail, onCancel }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between bg-slate-50 p-3 rounded-xl border border-slate-200 text-xs">
        ...
        <span className={`font-mono font-bold px-2 py-0.5 rounded ${expirySeconds < 60 ? 'bg-rose-100 text-rose-700' : 'bg-[#2F7C7A]/10 text-[#2F7C7A]'}`}>
