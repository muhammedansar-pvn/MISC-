...
export const StudentLayoutClient: React.FC<StudentLayoutClientProps> = ({ children }) => {
  ...
  const navCategories = [
    {
      ...
      items: [
        ...
        { label: 'My Profile', path: '/student/profile', icon: User, exact: true },
      ],
    },
    {
      title: 'ACADEMICS',
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Academic Transcript', path: '/student/transcript', icon: BookOpen },
      ],
    },
    {
      title: 'FINANCE',
      items: [
        { label: 'Payments & Fees', path: '/student/payments', icon: CreditCard },
      ],
    },
  ];
                ...
                {userMenuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-slate-200 py-2 z-40 animate-in fade-in slide-in-from-top-2 duration-150">
                      ...
                      >
                        <User className="w-4 h-4 mr-2 text-slate-400" /> View Profile
                      </Link>
