        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 z-10">
            <ScrollReveal delay={150} yOffset={25}>
              <div className="relative rounded-lg overflow-hidden border border-[#E2E8E0] shadow-md group">
                <div className="relative aspect-[4/3] bg-[#132238] overflow-hidden">
                  <img
                    src="/gate.jpg.jpeg"
                    alt="Jamia Markaz Gateway - Central Academic Governance Landmark"
                    className="w-full h-full object-cover object-center transition-transform duration-700 ease-out group-hover:scale-[1.03]"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#132238]/85 via-[#132238]/20 to-transparent flex items-end p-6">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4 text-[#475569] text-[15.5px] sm:text-[17px] leading-relaxed font-normal">
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-[#E2E8E0]">
              <div className="bg-[#F7F8F5] p-4 rounded border border-[#E2E8E0] space-y-1">
                ...
                <p className="text-xs sm:text-[13.5px] text-[#475569] leading-relaxed pl-6">
