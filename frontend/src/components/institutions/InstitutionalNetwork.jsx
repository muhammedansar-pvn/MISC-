  ...
  return (
    <section className="relative bg-white py-16 sm:py-20 lg:py-28 overflow-hidden border-b border-slate-200">
      <div className="relative misc-container z-10">
        ...
        <div className="bg-[#0B1D3A] text-white rounded-lg p-8 sm:p-12 border border-[#D4AF37]/30 shadow-md max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            <div className="inline-flex items-center space-x-2 bg-[#D4AF37]/10 border border-[#D4AF37]/40 px-3.5 py-1 rounded text-xs font-bold text-[#D4AF37] uppercase tracking-wider">
          ...
          <div className="flex justify-center">
            <div className="w-px h-8 bg-[#D4AF37]/50" />
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-slate-900/90 border border-slate-700 p-6 rounded text-center space-y-2">
              <div className="w-10 h-10 mx-auto rounded-full bg-[#D4AF37]/10 text-[#D4AF37] flex items-center justify-center border border-[#D4AF37]/30">
