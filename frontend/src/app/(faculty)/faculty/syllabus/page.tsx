...
function FacultySyllabusContent() {
  ...
  const filteredSyllabuses = syllabuses.filter((s) => {
    ...
    const subjectName = (s.subjectId as any)?.name || '';
    const matchesSearch =
      !searchQuery ||
        ...
        {filteredSyllabuses.length === 0 ? (
          <div className="p-12 text-center bg-white rounded-xl border border-[#E2E8E0] space-y-3">
            ...
            <p className="text-xs text-slate-400 max-w-sm mx-auto">
              No syllabus frameworks match your selected criteria. Try adjusting your subject filter.
            </p>
          </div>
        ) : (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500">
                      Course: {subject?.name || 'Academic Course'}
                    </p>
                  </div>
