...
import { Building2, Plus, Search, RefreshCw, AlertCircle, Eye, Edit3, X } from 'lucide-react';
import StatusBadge from '../components/admin/StatusBadge';
import { getInstitutions, createInstitution, updateInstitution } from '../services/institutionService';
        ...
        {loading ? (
          ...
          <div className="p-12 text-center space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 bg-[#2F7C7A] text-white font-bold text-xs rounded-lg uppercase"
            >
                  ...
                  <tr key={inst._id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50"
                      >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-sm">
              ...
              <div className="flex justify-end space-x-3 pt-3 border-t">
                <button
                  ...
                  className="px-4 py-2 border rounded-lg text-slate-700 text-xs font-bold"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2 bg-[#2F7C7A] text-white rounded-lg text-xs font-bold uppercase tracking-wider"
                >
