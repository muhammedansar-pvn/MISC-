...
export const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        navigate('/verify-email', { state: { email: response.email || formData.email.trim() } });
      } else {
      ...
      <div className="max-w-md w-full space-y-6 bg-white p-8 sm:p-10 rounded-xl border border-[#E2E8E0] shadow-sm">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded border border-[#E2E8E0] bg-white text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#2F7C7A] focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full px-3 py-2.5 rounded border border-[#E2E8E0] bg-white text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#2F7C7A] focus:border-transparent transition-all"
              >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="••••••••"
                className="w-full pl-9 pr-10 py-2.5 rounded border border-[#E2E8E0] bg-white text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-[#2F7C7A] focus:border-transparent transition-all"
              />
              <button
                type="button"
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#2F7C7A] text-white py-3 px-4 rounded font-bold hover:bg-[#256361] focus:outline-none focus:ring-2 focus:ring-[#2F7C7A] focus:ring-offset-2 transition-all disabled:opacity-50 text-xs tracking-wider uppercase shadow-sm"
            >
        ...
        <div className="text-center pt-3 border-t border-[#E2E8E0]">
          <p className="text-sm text-[#64748B]">
            ...
            <Link to="/login" className="font-semibold text-[#2F7C7A] hover:underline">
              Sign In
            </Link>
          </p>
        </div>
