...
import { GraduationCap, LogOut, User, Mail, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-2xl font-bold text-[#132238]">Faculty Portal</h1>
                <span className="px-2.5 py-0.5 text-xs font-bold bg-teal-100 text-teal-800 rounded-full">
                  FACULTY
                </span>
              </div>
              <p className="text-sm text-slate-500">Academic Faculty & Instructor Portal</p>
            </div>
          </div>
          <button
            onClick={logout}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-xl border border-[#E2E8E0] shadow-sm space-y-4">
            <h2 className="text-lg font-bold text-[#132238] border-b pb-2">Faculty Profile</h2>
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3 text-slate-700">
                ...
                <span className="font-semibold text-teal-700">{user?.role}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-200 shadow-sm space-y-3">
            ...
            <p className="text-sm text-emerald-700 leading-relaxed">
              Authenticated successfully as Faculty. Ready for mark entry, evaluation, and academic syllabus access.
            </p>
          </div>
        </div>
      </div>
