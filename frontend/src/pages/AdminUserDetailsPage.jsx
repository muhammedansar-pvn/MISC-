      ...
      <div className="bg-rose-50 border border-rose-200 rounded-2xl p-8 text-center max-w-lg mx-auto space-y-4 my-8">
        ...
        <div className="flex justify-center space-x-3 pt-2">
          <button
            ...
            className="px-4 py-2 bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold text-xs rounded-xl uppercase tracking-wider"
          >
            Back to Users List
          </button>
          <button
            onClick={fetchUser}
            className="px-4 py-2 bg-[#2F7C7A] hover:bg-[#256361] text-white font-bold text-xs rounded-xl uppercase tracking-wider inline-flex items-center"
          >
      ...
      <div className="bg-white rounded-2xl border border-[#E2E8E0] shadow-xs p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          ...
          <div className="flex items-start space-x-3.5 p-4 bg-slate-50 rounded-xl border border-slate-100">
            ...
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Account Creation Date</p>
          ...
          <div className="flex items-start space-x-3.5 p-4 bg-slate-50 rounded-xl border border-slate-100">
            <User className="w-5 h-5 text-[#2F7C7A] mt-0.5 flex-shrink-0" />
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Last System Update</p>
              <p className="font-semibold text-[#132238] mt-0.5">
