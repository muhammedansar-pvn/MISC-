...
import { Building2, LogOut, User, Mail, ShieldCheck } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h1 className="text-2xl font-bold text-[#132238]">Institution Portal</h1>
                <span className="px-2.5 py-0.5 text-xs font-bold bg-blue-100 text-blue-800 rounded-full">
                  INSTITUTION
                </span>
              </div>
              <p className="text-sm text-slate-500">Affiliated Institution Management Portal</p>
            </div>
          </div>
          <button
            onClick={logout}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-xl border border-[#E2E8E0] shadow-sm space-y-4">
            <h2 className="text-lg font-bold text-[#132238] border-b pb-2">Institution Account Details</h2>
          ...
          <div className="bg-emerald-50 p-6 rounded-xl border border-emerald-200 shadow-sm space-y-3">
            ...
            <p className="text-sm text-emerald-700 leading-relaxed">
              Authenticated successfully as Institution. Access granted to institution-level features and workflows.
            </p>
          </div>
        </div>
      </div>
