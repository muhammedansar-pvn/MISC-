  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex space-x-2 border-b border-[#E2E8E0] pb-1">
        {[
          { id: 'academic-years', label: 'Academic Years', icon: Calendar, count: academicYears.length },
          { id: 'classes', label: 'Classes', icon: Layers, count: classesList.length },
          { id: 'subjects', label: 'Subjects', icon: BookOpen, count: subjectsList.length },
          { id: 'syllabuses', label: 'Syllabuses', icon: FileText, count: syllabusesList.length },
        ].map((tab) => {
          const Icon = tab.icon;
          return (
            <button
      ...
      <div className="bg-white rounded-2xl border border-[#E2E8E0] shadow-xs overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center space-y-4">
            ...
            <button onClick={fetchAllAcademicData} className="px-4 py-2 bg-[#2F7C7A] text-white font-bold text-xs rounded-lg uppercase">
                ...
                {academicYears.map((ay) => (
                  <tr key={ay._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button onClick={() => handleOpenModal(ay)} className="px-3 py-1.5 border rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50">
              ...
              <tbody className="divide-y divide-[#E2E8E0]">
                {classesList.map((cls) => (
                  <tr key={cls._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button onClick={() => handleOpenModal(cls)} className="px-3 py-1.5 border rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50">
                        <Edit3 className="w-3.5 h-3.5 inline mr-1" /> Edit
                      </button>
                    </td>
                  </tr>
              ...
              <tbody className="divide-y divide-[#E2E8E0]">
                {subjectsList.map((sbj) => (
                  <tr key={sbj._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button onClick={() => handleOpenModal(sbj)} className="px-3 py-1.5 border rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50">
                        <Edit3 className="w-3.5 h-3.5 inline mr-1" /> Edit
                      </button>
                    </td>
                  </tr>
              ...
              <tbody className="divide-y divide-[#E2E8E0]">
                {syllabusesList.map((syl) => (
                  <tr key={syl._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button onClick={() => handleOpenModal(syl)} className="px-3 py-1.5 border rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-50">
                        <Edit3 className="w-3.5 h-3.5 inline mr-1" /> Edit
                      </button>
                    </td>
                  </tr>
